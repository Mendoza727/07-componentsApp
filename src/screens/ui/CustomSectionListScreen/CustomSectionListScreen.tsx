...
export const CustomSectionListScreen = () => {
  ...
  return (
    <CustomView>
      <TitleComponent title="Section List" />

      <CardComponent style={{ paddingVertical: 20 }}>
        <SectionList
          sections={houses}
          ...
          ListHeaderComponent={() => <TitleComponent title="Personajes" />}
          ListFooterComponent={() => (
            <TitleComponent title={`Secciones totales: ${houses.length}`} />
          )}
          style={{
